...
export const askLocalOpenAI = createAction({
  auth: localOpenaiAuth,
  name: 'askLocalLlm',
  displayName: 'Ask Local LLM',
  description: 'Ask your Local LLM anything you want!',
  props: {
    ...
    maxTokens: Property.Number({
      ...
      required: true,
      description:
        "The maximum number of tokens to generate. This is entirely dependant on the model you are running, llama3 by default has 8192K context",
      defaultValue: 2048,
    }),
